...
RSpec.describe QuestionsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #quiz' do
      expect(:get => '/questions/1/quiz').to route_to('questions#quiz', :id => '1')
    end

    it 'routes to #check_answer' do
      expect(:post => '/questions/1/quiz').to route_to('questions#check_answer', :id => '1')
    end
  end
end
